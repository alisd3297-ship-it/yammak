...
## القرارات المعتمدة
- البدء: المرحلة 0 (الأساس) ثم المرحلة 1 (المحفظة والتسويات المالية) في هذه الدفعة.
- العملة: IQD هي عملة الحساب الوحيدة في كل الأرصدة والحركات والتسويات، وUSD عرض فقط.
- كل مرحلة تُنفَّذ كمجموعة كاملة: قاعدة البيانات + RPCs + واجهات الزبون والمندوب والتاجر والإدارة + التقارير، قبل الانتقال للمرحلة التالية.
