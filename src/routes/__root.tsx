...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "يمّك | ويّانه كلشي صار يمّك" },
      {
        name: "description",
        content: "منصة يمّك العراقية: مطاعم، متاجر، مندوب، توصيل خاص، تكسي، ومهن وخدمات بمكان واحد.",
      },
      { property: "og:title", content: "يمّك | ويّانه كلشي صار يمّك" },
      { property: "og:description", content: "كل خدماتك اليومية بمكان واحد." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#c81e2b" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "يمّك" },
