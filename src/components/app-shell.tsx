    ...
    <header className="brand-gradient rounded-b-3xl px-5 pb-6 pt-7 text-primary-foreground shadow-card">
      <div className="relative flex min-h-11 flex-col items-center justify-center text-center">
        ...
        <img
          ...
          width={48}
          height={48}
          className="mb-1 size-12 rounded-2xl bg-primary-foreground p-1 shadow-soft"
        />
...
/** الأقسام العشرة الرئيسية للوحة الإدارة بالترتيب المعتمد. */
const ADMIN_LINKS = [
  ...
  { to: "/admin/sections", label: "الأقسام والتخصصات", exact: false },
  ...
  { to: "/admin/push", label: "مراقبة الإشعارات", exact: false },
